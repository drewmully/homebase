...
export default function AgentsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-8 py-6">
      <h1 className="text-lg font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>Agents</h1>
      <div
      ...
      >
        ...
        <p className="text-sm max-w-sm" style={{ color: 'var(--text-muted)' }}>
          AI-powered agents for automated reporting, alerting, and task management are being built.
        </p>
      </div>
    </div>
  )
